...
func CreatedDate(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func UpdatedDate(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func CreatedDateEQ(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreatedDate), v))
	})
}
...
func CreatedDateNEQ(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func CreatedDateIn(vs ...time.Time) predicate.Category {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedDateNotIn(vs ...time.Time) predicate.Category {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedDateGT(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func CreatedDateGTE(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func CreatedDateLT(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func CreatedDateLTE(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func UpdatedDateEQ(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdatedDate), v))
	})
}
...
func UpdatedDateNEQ(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func UpdatedDateIn(vs ...time.Time) predicate.Category {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedDateNotIn(vs ...time.Time) predicate.Category {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedDateGT(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func UpdatedDateGTE(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func UpdatedDateLT(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func UpdatedDateLTE(v time.Time) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
// HasCategoryWords applies the HasEdge predicate on the "category_words" edge.
func HasCategoryWords() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(CategoryWordsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, CategoryWordsTable, CategoryWordsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasCategoryWordsWith applies the HasEdge predicate on the "category_words" edge with a given conditions (other predicates).
func HasCategoryWordsWith(preds ...predicate.Word) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(CategoryWordsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, CategoryWordsTable, CategoryWordsPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
