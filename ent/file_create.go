...
func (fc *FileCreate) SetSize(i int16) *FileCreate {
...
func (fc *FileCreate) SetCreatedDate(t time.Time) *FileCreate {
...
func (fc *FileCreate) check() error {
	...
	if _, ok := fc.mutation.CreatedDate(); !ok {
		return &ValidationError{Name: "created_date", err: errors.New(`ent: missing required field "File.created_date"`)}
	}
	return nil
}
